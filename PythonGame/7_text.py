...
#적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/wallm/OneDrive/바탕 화면/PythonGame/enemy.png")
enemy_size = enemy.get_rect().size #이미지의 크기를 구해욤
...
while running:
    ...
    #경과 사간(ms)을 1000으로 나누어서  초(s) 단위로 표시
    timer = game_font.render(str(int(total_time - elapsed_time)),True,(255,255,255))
    #출력
    screen.blit(timer,(10,10))

    #만약 시간이 0 이하이면 게임ㅈ ㅗㅇ료
