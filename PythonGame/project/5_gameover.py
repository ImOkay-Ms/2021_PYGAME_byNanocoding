...
image_path = os.path.join(current_path,"image/real") #images 폴더 위치 반환
print(image_path)
...
character_to_x = 0 #character 이동방향
character_speed = 5
...
while running:
    ...
    #게임 종료 메시지 / TimeOut(시간초과실패), Mission Complete(성공), Game Over(캐릭터 공에 맞음)
